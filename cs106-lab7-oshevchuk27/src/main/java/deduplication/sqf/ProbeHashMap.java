...
public class ProbeHashMap<K,V> extends AbstractHashMap<K,V> {
  ...
  private int numOfProbes;                                          // number of probes for a key
  ...
  /**
   * Getter for the number of probes for a key
   * @return the number of probes for a key
   */
